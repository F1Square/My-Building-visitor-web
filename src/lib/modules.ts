...
export const MODULE_VISIBILITY: Record<string, string[]> = {
  ...
  admin: [
    'buildings','users','inquiries','website-contacts','support-admin',
    'subscriptions-admin','promos','activity-logs','bank-details',
    'expenses','maintenance','announcements','visitors',
    'complaints','helpline','refer','newspaper','society-rules',
  ],
  watchman: ['visitors','helpline'],
};

export const SUBSCRIPTION_GATED_MODULES = [
  'maintenance', 'announcements', 'visitors', 'parking', 'chat',
  'join-requests', 'details', 'helpline', 'members', 'expenses',
  'refer', 'society-rules', 'complaints',
];
...
export const ALL_MODULES: ModuleConfig[] = [
  ...
  { key: 'buildings',         label: 'Buildings',        icon: 'Building2',      path: '/dashboard/admin/buildings',      color: '#3B5FC0', bg: '#E8EEF9' },
  ...
  { key: 'website-contacts',  label: 'Website Contacts', icon: 'Mail',           path: '/dashboard/admin/website-contacts', color: '#EF4444', bg: '#FEE2E2' },
